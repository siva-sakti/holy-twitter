        ...
        <div className="px-6 py-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="text-[15px] text-[#0f1419] dark:text-[#e7e9ea] leading-relaxed space-y-4">
              <p>
                Hi, I'm <span className="font-semibold">Gargi Bala</span>, a child of the internet. I can't count the number of times my brain itches to scroll and my fingers reach for the timeline. It's probably a 1000x order of magnitude more than I've prayed, over the past decade plus of being online (sometimes chronically so).
              </p>
              <p>
                Though I've succumbed to the act of scrolling, the content I saw always dissatisfied me. I want to contemplate spiritual teachings as much as I can in this life, and so I might as well use these optimized reward circuits for a better cause. Plus this feels way more like community — and even home — to me. Hope you can find joy and a path toward peace through this, too :)
              </p>
            </div>
          </section>
